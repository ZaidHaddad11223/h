///هذا البوت الاصدار الثاني من بوت السيستم تحت ادارة فيروكس وشركائه :
...
const youtube = new YouTube("AIzaSyA85w8hEyVH93YVIZkjnk3RQr2ZJ47UVrw"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyA85w8hEyVH93YVIZkjnk3RQr2ZJ47UVrw"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@670692429623459870>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content === "صباح الخير") {
    message.channel.send("**:heart:صباح النور:heart:**");
    message.channel.sendFile("");
  }
});
